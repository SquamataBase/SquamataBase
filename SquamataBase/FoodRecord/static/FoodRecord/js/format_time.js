$(document).ready(function() {
    ...
    $("#id_start_time_2").on("change", function() {
        match_time("#id_start_time_0", this);
    });
    
    $("#id_end_time_2").on("change", function() {
        match_time("#id_end_time_0", this);
    });
    
    $("*").on("focus", function() {
        match_time("#id_start_time_0", "#id_start_time_2");
    });
    
    $("*").on("focus", function() {
        match_time("#id_end_time_0", "#id_end_time_2");
    });
