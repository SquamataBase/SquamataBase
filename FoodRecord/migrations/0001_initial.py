    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_date', models.CharField(blank=True, max_length=255, null=True, validators=[FoodRecord.validators.validate_date])),
                ('start_time', models.CharField(blank=True, max_length=255, null=True, validators=[FoodRecord.validators.validate_time])),
                ('end_time', models.CharField(blank=True, max_length=255, null=True, validators=[FoodRecord.validators.validate_time])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.CharField(blank=True, max_length=255, null=True, validators=[FoodRecord.validators.validate_date])),
                ('end_date', models.CharField(blank=True, max_length=255, null=True, validators=[FoodRecord.validators.validate_date])),
            ],
            options={
                'db_table': 'sb_dataset',
            },
